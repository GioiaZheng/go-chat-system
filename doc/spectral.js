 ...
 * @description Spectral configuration tailored to the course OpenAPI guidelines.
 */
...
export default {
  ...
  rules: {
    // Allow preferred keywords while favoring `examples` over deprecated `example` entries.
    'ibm-schema-keywords': {
    ...
    // Keep operationId values in camelCase to match the OpenAPI contract guidance.
    ...
    // Prefer camelCase properties for consistency with the API specification.
    ...
    // Keep rule coverage aligned with the course rubric while relaxing non-evaluated checks.
